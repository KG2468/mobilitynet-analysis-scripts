...
#SBATCH --nodes=1
#SBATCH --mem=500G
# Execute get_int_aligned_jerk_sweep.ipynb. The notebook is executed
# in order, and the executed result is written to
# get_int_aligned_jerk_sweep.executed.ipynb so the computed outputs are preserved.

source setup/activate_conda.sh

set -euo pipefail

NOTEBOOK="get_int_aligned_jerk_sweep.ipynb"
OUTPUT="get_int_aligned_jerk_sweep.executed.ipynb"

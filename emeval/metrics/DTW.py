...
def calDistance(point1, point2):
    ...
    :param point2: another Shapely Point
    ...
    dLat = math.radians(point1.y-point2.y)
    dLon = math.radians(point1.x-point2.x)
    ...
    def calculate(self):
        for i in range(len(self._seq1)):
            for j in range(len(self._seq2)):
                self.calculate_backward(i, j)
        return self._map[(len(self._seq1) - 1, len(self._seq2) - 1)]
